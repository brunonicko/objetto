...
class TestHistoryFlushing(unittest.TestCase):
    ...
    def test_history_adoption(self):
        ...
        self.assertIs(seq_a.__get_history__(), hist_a)
        self.assertIs(seq_b.__get_history__(), seq_a.__get_history__())
        self.assertIs(seq_c.__get_history__(), seq_a.__get_history__())
